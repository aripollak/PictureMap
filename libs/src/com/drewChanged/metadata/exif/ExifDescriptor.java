...
import com.drewChanged.imaging.PhotographicConversions;
...
//        return formatter.format(focalLength.doubleValue()) + " mm";
        return "0.0"+ focalLength.doubleValue() + " mm";
    }
...
//        return formatter.format(distance.doubleValue()) + " metres";
        return "0.0 "+ distance.doubleValue()+ " metres";
    }
